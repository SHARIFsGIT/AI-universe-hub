  ...
  <div class="card-body">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <div>
        ...
        <p><img src="images/calendar.svg" width="14" alt="" loading="lazy"> <span>${published_in}</span></p>
      </div>

      <div class="show_details">
        <!-- modal btn or clicker -->
        <button class="btn p-1 border border-dark-subtle rounded-circle" data-bs-toggle="modal"
          data-bs-target="#${modalId}">
          <img src="images/eye-slash-fill.svg" width="24" alt="">
        </button>
      </div>
